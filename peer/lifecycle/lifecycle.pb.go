...
func file_peer_lifecycle_lifecycle_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_peer_lifecycle_lifecycle_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_peer_lifecycle_lifecycle_proto_msgTypes[29].Exporter = func(v any, i int) any {
		...
		file_peer_lifecycle_lifecycle_proto_msgTypes[32].Exporter = func(v any, i int) any {
